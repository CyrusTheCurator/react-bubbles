...
Josh Luscombe - 2020
Tokens are used to authenticate users with locally stored bits of information that allow for continuous access to password-protected information.

Use microservices to store passwords, do not store any sensitive data on the DOM

Web servers service a specific domain and provide it (usually) with an associated hosted file/program. Users that point to the URL of the server can then access the information it is set up to share.
